...
export const headerlinksToTest = [
  ...
  { title: 'Test', url: '/TEST/test.html' },
  { title: 'Contacts', url: '#contacts' },
];

export const userItemsLinksToTest = [
...
export const expectedFirstDescription =
...
export const expectedSecondDescription =
...
export const expectedSection2ContentText =
...
export const expectedSection3ContentText =
  'Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Donec id elit non mi porta gravida at eget metus. Curabitur blandit tempus porttitor. Etiasem malesuada magn. Vestibulum felis euismod semper.';
